...
const CVViewer:React.FC=()=>{
    ...
    return (
        <div>
        <button onClick={()=>setModalOpen(true)} className="inline-block ml-4 px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">View My CV</button>
        <a
        ...
        className="inline-block ml-4 px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            ...
            {isModalOpen && (
             ...
             alt="My CV" 
             layout="responsive"
             width={900} height={1270} className="w-full" 
             />
                    </div>
                </div>
            )}
