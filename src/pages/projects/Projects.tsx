        ...
        >
            ...
            <div className="relative inline-block">
                ...
                <button
                    ...
                    onClick={prevSlide}
                    className={`absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-full pr-4 ${hoverEffect ? "opacity-75" : "opacity-100"}`}
                >
                    Prev
                </button>
                <button
                    ...
                    onMouseLeave={() => setHoverEffect(false)}
                    onClick={nextSlide}
                    className={`absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-full pl-4 ${hoverEffect ? "opacity-75" : "opacity-100"}`}
                >
                    Next
                </button>
            </div>
